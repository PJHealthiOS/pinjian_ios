...
-(NSString*) getToken
{
    ...
    if(token){
        ...
        if(!_user){
            ...
            _user.memberLevel = [userDefaults objectForKey:@"memberLevel"];
            _user.discountRate = [userDefaults objectForKey:@"discountRate"];
            _user.curAvailableTimes = [userDefaults objectForKey:@"curAvailableTimes"];
...
-(void) setLogin:(UserVO *) user
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:user.memberLevel forKey:@"memberLevel"];
    [[NSUserDefaults standardUserDefaults] setObject:user.discountRate forKey:@"discountRate"];
    [[NSUserDefaults standardUserDefaults] setObject:user.curAvailableTimes forKey:@"curAvailableTimes"];
