...
// 我的优惠券1.2.0
-(void) getCouponslistAndCallback: (void (^)(id  data))callback
{
    NSURL *URL = [NSURL URLWithString:[NSString stringWithFormat:@"%@userCoupons/list?pageSize=10&pageNo=1",[ServerManger getInstance].serverURL]];
    [self getHttp:URL.absoluteString parameters:nil version:@"3" andCallback:callback];
}
...
-(void) getHospitals:(NSString*) msg serviceType:(NSString *)serviceType oppointment:(int)oppointment size:(int) size page:(int) page longitude:(NSString*) longitude latitude:(NSString*) latitude orderBy:(int)orderBy cityId:(NSString *)cityId andCallback: (void (^)(id  data))callback
{
...
{
    NSString * orderURL = [NSString stringWithFormat:@"%@%@/%@/pay?channel=%@",[ServerManger getInstance].serverURL,isExpert?@"pjOrder":@"order",orderID,channel];
    [self postHttp:orderURL parameters:nil version:@"3" andCallback:callback];
}
///普通挂号详情
