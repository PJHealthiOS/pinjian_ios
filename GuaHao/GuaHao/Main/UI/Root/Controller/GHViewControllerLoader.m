...
{
    return  (NormalOrderPayViewController *)[[self HomePageStoryBoard]instantiateViewControllerWithIdentifier:@"NormalOrderPayViewController"];
}

+(NormalDiscountListViewController *)NormalDiscountListViewController{
    return  (NormalDiscountListViewController *)[[self MySelfStoryBoard]instantiateViewControllerWithIdentifier:@"NormalDiscountListViewController"];

}
+(NewNormalAcceptViewController *)NewNormalAcceptViewController{
    return  (NewNormalAcceptViewController *)[[self OrderCenterStoryBoard]instantiateViewControllerWithIdentifier:@"NewNormalAcceptViewController"];

}
+(NewNormalCardAcceptViewController *)NewNormalCardAcceptViewController{
    return  (NewNormalCardAcceptViewController *)[[self OrderCenterStoryBoard]instantiateViewControllerWithIdentifier:@"NewNormalCardAcceptViewController"];
