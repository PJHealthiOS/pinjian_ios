...
//            }];
            ...
            NSString *leftStr = [DataManager getInstance].user.discountRate.floatValue > 0 ?[NSString stringWithFormat:@"%@陪诊费%.1f折",expInfoVO.curDiscountDesc,expInfoVO.curDiscountValue.floatValue *10] :@"无";
