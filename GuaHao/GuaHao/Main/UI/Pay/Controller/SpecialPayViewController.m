...
-(void)initView{
    ...
    if (payVO.couponse_pay) {
        ...
        ///优惠券的钱
        self.couponNumberLabel.text = [NSString stringWithFormat:@"-%@元",payVO.couponse_pay.money];
    }
...
-(void)reloadPayInfo{
    ...
    self.discountLabel.text = self.selectCoupon.name;
    self.discountNumberLabel.text = [NSString stringWithFormat:@"-%@元",self.selectCoupon.money];
