...
- (void)viewDidLoad {
    ...
    __weak typeof(self) weakSelf = self;
        ...
        [[ServerManger getInstance] getPayExpertOrderPageData:_orderID andCallback:^(id data) {
...
- (IBAction)discountAction:(id)sender {
    ...
    listVC.orderID = payVO.id.stringValue;
...
-(void)accountPayPolling:(NSString *)orderID parameters:(NSDictionary *)parameters{
    ...
    dispatch_source_set_event_handler(_timer, ^{
        ...
        //在这里执行事件
        [[ServerManger getInstance] getSpecialOrderPayStatus:orderID andCallback:^(id data) {
