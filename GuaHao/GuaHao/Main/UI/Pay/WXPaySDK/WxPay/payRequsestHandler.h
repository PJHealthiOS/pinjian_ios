...
#define APP_ID          @"wx696fa79565c46811"               //APPID
#define APP_SECRET      @"e1b543878917f7a93a56ea9384557ac5" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1318240301"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"pinjianguahao20160301pinjianguah"
//支付结果回调页面
