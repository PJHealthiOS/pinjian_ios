//
//  GHAcceptCompanyDetailViewController.m
//  GuaHao
//
//  Created by PJYL on 2017/10/11.
//  Copyright © 2017年 pinjian. All rights reserved.
//

#import "GHAcceptCompanyDetailViewController.h"
#import "GHAcceptOrderStatusCell.h"
#import "GHAcceptOrderWJInfoCell.h"
@interface GHAcceptCompanyDetailViewController ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation GHAcceptCompanyDetailViewController
...
-(void)getInfoDesc
{
    ...
    /////万家接单详情页
    [[ServerManger getInstance] getCompanyOrderDetail:self.order.id.stringValue andCallback:^(id data) {
...
-(void)operation:(int)opID{
    [self.view makeToastActivity:CSToastPositionCenter];
    [[ServerManger getInstance] companyOrderOperation:_orderVO.id operationID:[NSNumber numberWithInt:opID] andCallback:^(id data) {
